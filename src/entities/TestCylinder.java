...
public class TestCylinder extends Object3D
{
   ...
   private static models.Model makeModel()
   {
      ...
      MeshInstance mi2 = new MeshInstance(mesh2, 0xffFF6040, new XYZ(0, 0, 2), 0, -Math.PI / 4);
      MeshInstance mi3 = new MeshInstance(mesh3, 0xffFFFFFF, new XYZ(0, 0, 2), 0, -Math.PI / 4);
