      ...
      for(double d = 0; d < 360; d++)
      {
         ...
         for(int x = min_x - 1; x <= max_x + 1; x++)
         {
            for(int y = min_y - 1; y <= max_y + 1; y++)
            {
               ...
               double dist_bl = LevelUtil.nodeEdgeDist(bl, start, end);
               double dist_br = LevelUtil.nodeEdgeDist(br, start, end);
               double dist_tl = LevelUtil.nodeEdgeDist(tl, start, end);
               double dist_tr = LevelUtil.nodeEdgeDist(tr, start, end);
